...
class UploadHandler
{
    ...
    /**
     * Jimvirle E. Calago
     * Generate unique name base on microtime
     */
    protected function generate_microtime_filename($name)
    {
        $extension = '';
        if ($name != '')
        {
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error, $index = null, $content_range = null) {
        $file = new \stdClass();
        $name = !empty($this->options['custom_file_name']) ? $this->options['custom_file_name'] : $name;
